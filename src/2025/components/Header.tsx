...
export default function Header() {
  ...
  return (
    <header>
      <nav
        className={`fixed left-0 right-0 top-0 z-10 border-gray-200 transition duration-200 ${isScrolled ? "scrolled bg-white shadow-xl" : "bg-transparent"}`}
      >
        <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between px-10 py-5">
          ...
          >
            <img src="/2025/nav-logo.png" className="h-8" alt="Flowbite Logo" />
          </a>
          <button
